...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("Control Remote Desktop", "Conectar a otro equipo"),
        ...
        ("install_tip", "Debido al Control de cuentas de usuario, es posible que RustDesk no funcione correctamente como escritorio remoto. Para evitar este problema, haga clic en el botón de abajo para instalar OLG Desk en el sistema."),
        ("Click to upgrade", "Clic para actualizar"),
        ("Configure", "Configurar"),
        ("config_acc", "Para controlar su escritorio desde el exterior, debe otorgar permiso a OLG Desk de \"Accesibilidad\"."),
        ("config_screen", "Para controlar su escritorio desde el exterior, debe otorgar permiso a OLG Desk de \"Grabación de pantalla\"."),
        ...
        ("Show RustDesk", "Mostrar OLG Desk"),
        ("This PC", "Este PC"),
        ("or", "o"),
