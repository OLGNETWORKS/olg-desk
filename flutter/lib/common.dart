...
class MyTheme {
  ...
  static const Color accent50 = Color(0x77005A9E);
  static const Color accent80 = Color(0xAA005A9E);
  ...
  static const Color button = Color(0xFF005A9E);
...
Widget loadPowered(BuildContext context) {
  ...
  return MouseRegion(
    ...
    child: GestureDetector(
      onTap: () {
        launchUrl(Uri.parse('https://olgsys.com'));
      },
      child: Opacity(
          opacity: 0.5,
          child: Text(
